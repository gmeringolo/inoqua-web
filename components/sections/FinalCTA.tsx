 ...
 */
export default function FinalCTA({ title, subtitleRegular, subtitleBold, button, secondaryButton }: FinalCTAProps) {
  return (
    <section className="relative flex min-h-[420px] items-center justify-center overflow-hidden px-6 py-16 sm:px-10 lg:px-20">
      ...
      <Reveal className="relative mx-auto flex max-w-4xl flex-col items-center rounded-final bg-white/85 px-10 py-14 text-center shadow-lg backdrop-blur-sm">
        <h2 className="text-titulo-xxl text-[#282828]">{title}</h2>
