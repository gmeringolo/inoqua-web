...
export const businessTypesGrid = {
  ...
  chips: [
    ...
    { icon: "package" as const, label: "Rotiserías" },
    { icon: "package" as const, label: "Panaderías" },
    { icon: "fork" as const, label: "Pizzerías" },
    { icon: "fork" as const, label: "Fábrica de pastas" },
    { icon: "package" as const, label: "Heladerías" },
    { icon: "fork" as const, label: "Pescaderías" },
    { icon: "fork" as const, label: "Comidas al paso" },
    { icon: "fork" as const, label: "Cantinas con elaboración" },
    { icon: "fork" as const, label: "Elaboración de sandwiches" },
    { icon: "building" as const, label: "Salón de fiestas" },
    { icon: "fork" as const, label: "Parrilladas" },
  ],
};
