export const heroContent = {
  breadcrumb: "Servicios — Habilitaciones / Renovaciones bromatológicas",
  title: "Habilitá tu empresa de alimentos sin multas, demoras ni errores",
  subtitle:
    "Te acompañamos desde el inicio hasta tener todo en regla, sin que tengas que perder tiempo entendiendo trámites confusos.",
...
export const problemSection = {
  title: "¿Estás intentando habilitar tu negocio y no sabés por dónde empezar?",
  subtitle: "Muchos emprendedores se encuentran con:",
  cards: [
    { icon: "clipboard" as const, text: "Requisitos poco claros" },
    { icon: "eye" as const, text: "Observaciones inesperadas" },
    { icon: "money" as const, text: "Reformas que no estaban previstas" },
    { icon: "clock" as const, text: "Demoras interminables con los trámites" },
    { icon: "warning" as const, text: "Riesgos de multas o clausura" },
  ],
};

export const alertBannerText =
  "El problema no es tu negocio. Es no contar con el respaldo técnico adecuado desde el inicio";
...
export const featureSplitSection = {
  ...
  items: [
    ...
    "Detección de incumplimientos antes de la inspección",
  ...
  image: "/img/abilitaciones-solucion.png",
};
...
export const businessTypesGrid = {
  ...
  chips: [
    ...
    { icon: "shoppingBasket" as const, label: "Supermercados" },
    { icon: "ferrisWheel" as const, label: "Ferias gastronómicas" },
    { icon: "iceCream" as const, label: "Heladerías" },
    { icon: "balloon" as const, label: "Salón de fiestas" },
    { icon: "ham" as const, label: "Fiambrería / Quesería" },
    { icon: "flame" as const, label: "Parrilladas" },
    { icon: "fish" as const, label: "Pescaderías" },
    { icon: "wheat" as const, label: "Fábrica de pastas" },
    { icon: "sandwich" as const, label: "Sandwiches" },
    { icon: "banana" as const, label: "Fruterías y verdulerías" },
    { icon: "chefHat" as const, label: "Catering" },
